...
* https://www.minseong.kim/ +
* https://velog.io/@jsj3282 +
...
include::{snippets}/sign-in/response-body.adoc[]
...
include::{snippets}/sign-out/response-body.adoc[]
...
include::{snippets}/update-password/response-body.adoc[]
=== 2-2. Cafe
...
include::{snippets}/add-heart/path-parameters.adoc[]

===== HTTP Request

include::{snippets}/add-heart/http-request.adoc[]

===== Response Body

include::{snippets}/add-heart/response-body.adoc[]

==== 좋아요 제거

===== Path Parameters

include::{snippets}/remove-heart/path-parameters.adoc[]

===== HTTP Request

include::{snippets}/remove-heart/http-request.adoc[]

===== Response Body

include::{snippets}/remove-heart/response-body.adoc[]
